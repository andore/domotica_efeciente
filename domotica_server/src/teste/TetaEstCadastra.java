...
public class TetaEstCadastra {
	...
	{	
		try 
		{
			...
			System.out.println("id Sensor:" + est.getAtuadores().get(0).getId());
			System.out.println("codigo sensor:" + est.getAtuadores().get(0).getCod());
			System.out.println("descricao sensor:" + est.getAtuadores().get(0).getDescricao());
