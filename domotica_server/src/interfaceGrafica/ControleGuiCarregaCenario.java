...
public class ControleGuiCarregaCenario extends AbstractControleGui implements ListenerGuiCadastraCenario
{
	private GuiCarregarCenario janela;
	...
	final static Logger logger = Logger.getLogger(ControleGuiCarregaCenario.class);
	
	public ControleGuiCarregaCenario(ListenerCtrlCadastraCenario listener)
	{
		this.listener = listener;
		janela = new GuiCarregarCenario(this);
		setCompDisable();
		cenario = new Cenario();
	...
	private void setCompDisable()
	{
		...
		janela.lampSta.setEnabled(false);
		janela.janela.setEnabled(false);
		janela.cenarioBox.setEnabled(false);
	...
	public GuiCarregarCenario getJanela()
	{
		return janela;
	}
